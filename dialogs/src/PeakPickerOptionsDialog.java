...
*/
/*
* PeakPickerOptionsDialog.java
*
* Created on 15 October 2008, 16:48
*/
...
* @author  aceroni
*/
public class PeakPickerOptionsDialog extends javax.swing.JDialog {
    
    /** Creates new form PeakPickerOptionsDialog */
    public PeakPickerOptionsDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PeakPickerOptionsDialog dialog = new PeakPickerOptionsDialog(new javax.swing.JFrame(), true);
