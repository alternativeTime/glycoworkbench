...
public class PeakListPanel extends SortingTablePanel<PeakList> implements
	...
	protected void createActions() {
		...
		// file
		theActionManager.add("new", GlycoWorkbench.getDefaultThemeManager().getResizableIcon(STOCK_ICON.REFRESH, Plugin.DEFAULT_ICON_SIZE), "Clear",
				KeyEvent.VK_N, "", this);
		theActionManager.add("open", GlycoWorkbench.getDefaultThemeManager().getResizableIcon(STOCK_ICON.DOCUMENT_OPEN, Plugin.DEFAULT_ICON_SIZE), "Open",
				KeyEvent.VK_O, "", this);
		theActionManager.add("save",GlycoWorkbench.getDefaultThemeManager().getResizableIcon(STOCK_ICON.DOCUMENT_SAVE, Plugin.DEFAULT_ICON_SIZE), "Save",
				KeyEvent.VK_S, "", this);
		theActionManager.add("saveas", GlycoWorkbench.getDefaultThemeManager().getResizableIcon(STOCK_ICON.DOCUMENT_SAVE_AS, Plugin.DEFAULT_ICON_SIZE),
				"Save as...", KeyEvent.VK_A, "", this);

		// print
		theActionManager.add("print", GlycoWorkbench.getDefaultThemeManager().getResizableIcon(STOCK_ICON.DOCUMENT_PRINT, Plugin.DEFAULT_ICON_SIZE), "Print...",
				KeyEvent.VK_P, "", this);

		// edit
		theActionManager.add("undo", GlycoWorkbench.getDefaultThemeManager().getResizableIcon(STOCK_ICON.UNDO, Plugin.DEFAULT_ICON_SIZE), "Undo",
				KeyEvent.VK_U, "", this);
		theActionManager.add("redo", GlycoWorkbench.getDefaultThemeManager().getResizableIcon(STOCK_ICON.REDO, Plugin.DEFAULT_ICON_SIZE), "Redo",
				KeyEvent.VK_R, "", this);

		theActionManager.add("add", FileUtils.defaultThemeManager.getImageIcon("add"), "Add peak",
				KeyEvent.VK_D, "", this);
		theActionManager.add("cut", GlycoWorkbench.getDefaultThemeManager().getResizableIcon(STOCK_ICON.CUT, Plugin.DEFAULT_ICON_SIZE), "Cut",
				KeyEvent.VK_T, "", this);
		theActionManager.add("copy", GlycoWorkbench.getDefaultThemeManager().getResizableIcon(STOCK_ICON.COPY, Plugin.DEFAULT_ICON_SIZE), "Copy",
				KeyEvent.VK_C, "", this);
		theActionManager.add("paste", GlycoWorkbench.getDefaultThemeManager().getResizableIcon(STOCK_ICON.PASTE, Plugin.DEFAULT_ICON_SIZE), "Paste",
				KeyEvent.VK_P, "", this);
		theActionManager.add("delete", GlycoWorkbench.getDefaultThemeManager().getResizableIcon("deleteNew", Plugin.DEFAULT_ICON_SIZE), "Delete",
